...
# Report: “AWS Cloud Mastery Series #1”

### Event Objectives

- Provide an overview of the AI/ML landscape in Vietnam.
- Introduce and demonstrate the comprehensive Amazon SageMaker platform for the ML lifecycle.
- Dive deep into Generative AI using Amazon Bedrock.
- Guide participants through Prompt Engineering techniques and the implementation of Retrieval-Augmented Generation (RAG).
