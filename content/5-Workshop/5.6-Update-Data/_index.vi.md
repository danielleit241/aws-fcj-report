...
> ![Image illustrating AI not knowing about Project Omega](link_anh_ai_dont_know)
...
> ![Image illustrating secret text file content on computer](link_anh_secret_file_content)

**Step 3: Upload and Sync**

Now, we will feed this new knowledge into the AI's "brain".

1.  Access the **S3 Console**, navigate to your old bucket (`rag-workshop-<your-name>`).
2.  Click **Upload** -> **Add files** -> Select the `secret-project.txt` file -> **Upload**.

> ![Image illustrating file successfully uploaded to S3](link_anh_upload_secret_s3)
...
> ![Image illustrating Sync process completion on Bedrock Console](link_anh_sync_new_data_success)
...
> ![Image illustrating AI answering correctly after data update](link_anh_ai_knows_secret)
